...
def phenotype_stripchart(data, trait, size = (10, 5)):
    ...
    traits = {
        ...
        'mpasd':('mito-perimarea-sd', 'SD of Mitochondrial Perimeter / Area', 'Perimeter / Area'),
        'mexsk': ('mito-ext-skew', 'Skewness of Mitochondrial Extent', 'Extent'),
        'mszsk': ('mito-size-skew', 'Skewness of Mitochondrial Size', 'Area (px)'),
        'mma': ('mito-minaxis-mean', 'Mean Mitochondrial Minor Axis Length', 'Length (px)'),
        'mecsd': ('mito-ecc-sd', 'SD of Mitochondrial Eccentricity', 'Eccentricity'),
        'msz': ('mito-size-mean', 'Mean Mitochondrial Size', 'Area ($\mu$m^2)'),
        'mds': ('mito-dist-med', 'Median of Mitochondrial Distribution', 'Median (%)'),
        'mdssd': ('mito-dist-sd', 'SD of Mitochondrial Distribution', 'Median (%)'),
        'mdssk': ('mito-dist-skew', 'Skewness of Mitochondrial Distribution', 'Skewness'),
        'mct': ('mito-tot-ct', 'Number of Mitochondrial Foci', 'Count'),
        'mct1': ('mito-prim-ct', 'Number of 1º Mitochondrial Foci', 'Count'),
        'mct2': ('mito-sec-ct', 'Number of 2º Mitochondrial Foci', 'Count'),
        'mct3': ('mito-tert-ct', 'Number of 3º Mitochondrial Foci', 'Count'),
        'mct4': ('mito-quat-ct', 'Number of 4º Mitochondrial Foci', 'Count'),
        'mcta': ('mito-ant-ct', 'Number of Anterior Mitochondrial Foci', 'Count'),
        'mctp': ('mito-post-ct', 'Number of Posterior Mitochondrial Foci', 'Count'),
        'oo': ('ori-order', 'Orientation Order', 'NA'),
        'mctbp': ('mito-branch-pt-ct', 'Number of Mitochondria in Branch Points', 'Count ($\mu$m^-1)'),
        'mbpct': ('mito-branch-pt-pct', 'Percent of Mitochondria in Branch Points', 'Percent (%)'),
        'tn': ('num-term-nodes', 'Number of Terminal Nodes', 'Count ($\mu$m^-1)'),
        'tnpct': ('pct-term-nodes', 'Percent of Terminal Nodes', 'Percent (%)'),
        'id': ('int-density', 'Intersection Density', '$\mu$m^-2'),
        'ed': ('edge-density', 'Edge Density', '$\mu$m^-1'),
        'mdg': ('mean-degree', 'Mean Degree of Intersections', 'NA'),
        'ndg4': ('num-degree-4+', 'Number of Intersections with Degree > 3', 'Count ($\mu$m^-1)'),
        'dg4pct': ('pct-degree-4+', 'Percent of Intersections with Degree > 3', 'Percent (%)')
        }
